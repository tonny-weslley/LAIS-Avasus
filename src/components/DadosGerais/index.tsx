import {TransparenciaCard, TransparenciaCardHeader, DadosGeraisCardItems, DadosGeraisCardItem, DadosGeraisCardItemHeader, DadosGeraisCardItemBody} from '../styled-components/Cards';
...
const DadosGerais = (dados: any) => {
            ...
            <DadosGeraisCardItems>
                ...
                <DadosGeraisCardItem>
                    ...
                    <DadosGeraisCardItemBody>
                        <TitleAlternative2> {dados.dados.usuarios_registrados.toLocaleString('pt-BR', {
  ...
  maximumFractionDigits: 2
                ...
                <DadosGeraisCardItem>
                    ...
                    <DadosGeraisCardItemBody>
                        <TitleAlternative2> {dados.dados.incricoes_realizadas.toLocaleString('pt-BR', {
  maximumFractionDigits: 2
})} </TitleAlternative2>
                    </DadosGeraisCardItemBody>
                </DadosGeraisCardItem>
                ...
                <DadosGeraisCardItem>
                    ...
                    <DadosGeraisCardItemBody>
                        <TitleAlternative2> {dados.dados.cursos_ativos.toLocaleString('pt-BR', {
  maximumFractionDigits: 2
})} </TitleAlternative2>
                    </DadosGeraisCardItemBody>
                </DadosGeraisCardItem>
                ...
                <DadosGeraisCardItem>
                    ...
                    <DadosGeraisCardItemBody>
                        <TitleAlternative2> {dados.dados.direito_certificacao} </TitleAlternative2>
                    </DadosGeraisCardItemBody>
                </DadosGeraisCardItem>
                ...
                <DadosGeraisCardItem>
                    ...
                    <DadosGeraisCardItemBody>
                        <TitleAlternative2> {dados.dados.investimento_medio_curso} </TitleAlternative2>
                    </DadosGeraisCardItemBody>
                </DadosGeraisCardItem>
                ...
                <DadosGeraisCardItem>
                    ...
                    <DadosGeraisCardItemBody>
                        <TitleAlternative2> {dados.dados.investimento_medio_aluno} </TitleAlternative2>
                    </DadosGeraisCardItemBody>
                </DadosGeraisCardItem>
